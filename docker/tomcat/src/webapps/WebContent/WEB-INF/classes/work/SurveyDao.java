...
/**
 * ----------------------------------------------------------------------*
 * ■■■SurveyDaoクラス■■■ 概要：DAO（「survey」テーブル）
 * ----------------------------------------------------------------------
 **/
public class SurveyDao {
	...
	String JDBC_URL = "jdbc:mysql://172.28.0.2/TEST_DB?characterEncoding=UTF-8&serverTimezone=JST&useSSL=false";
	...
	/**
	 * ----------------------------------------------------------------------*
	 * ■doInsertメソッド 概要 ：「survey」テーブルに対象のアンケートデータを挿入する 引数 ：対象のアンケートデータ（SurveyDto型）
